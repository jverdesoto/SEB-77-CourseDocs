...
function formatProducts(carousel, grid, sidebar) {
    const carouselProductsReformatted = carouselProducts.map(productName)
    const gridProductsReformatted = gridProducts.map(productName)
    const sidebarProductsReformatted = sidebarProducts.map(productName)

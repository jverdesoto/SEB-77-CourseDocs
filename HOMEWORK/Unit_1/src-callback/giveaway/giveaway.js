...
// YOUR CODE HERE:
function determineCouponRecipients(allUsers, cb) {
  const allUsersEligibleForCoupon = []
  allUsers.forEach(user => {
    if(cb(user)){
    allUsersEligibleForCoupon.push(user)}
  })
  return allUsersEligibleForCoupon
};
